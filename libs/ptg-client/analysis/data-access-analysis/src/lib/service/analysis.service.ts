...
import { Analysis, CreateAnalysis, ExportAnalysis } from '@ptg/analysis-types';
...
export class AnalysisService {
  ...
  exportAnalysis(payload: ExportAnalysis): Observable<Blob> {
    return this._httpClient.post(
      `${this._apiUrl}/indicator-realizations/export-analysis-excel`,
      payload,
      {
        responseType: 'blob',
      },
